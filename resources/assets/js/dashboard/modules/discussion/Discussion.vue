<template>
    <div class="row">
        <vue-table :title="$t('page.discussions')" :fields="fields" api-url="discussion" :item-actions="itemActions"
                   @table-action="tableActions" show-paginate>
            <template slot="buttons">
                <router-link :to="{ name: 'dashboard.discussion.create' }" class="btn btn-sm btn-success">{{
                    $t('page.create') }}
                </router-link>
            </template>
        </vue-table>

                ...
                <table id="uploads-table" class="table table-striped table-hover">
                    ...
                    <tr v-for="(file, index) in upload.files">
                        <template v-if="file.type == 'folder'">
                            ...
                            <td>
                                <button type="button" class="btn btn-sm btn-danger"
                                        @click="deleteFolder(file.fullPath)">
                                    <i class="fas fa-trash-alt"></i>
                                </button>
                            </td>
                        </template>
                        <template v-else>
                            ...
                            <td>{{ file.size }}</td>
                            <td>
                                <button type="button" class="btn btn-sm btn-info" v-if="checkImageType(file.mimeType)"
                                        @click="preview(file.webPath)">
        ...
        <modal :show="showFolder" @confirm="confirm" @cancel="showFolder = false" show-footer>
            ...
            <form>
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" id="folder" class="form-control" v-model="folder"
                               :placeholder="$t('form.folder_name')">
                    </div>
                </div>
            </form>
        </modal>
        <modal :show="showFile" @confirm="uploadFile" @cancel="showFile = false" show-footer>
            ...
            <form enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" id="file_name" class="form-control" name="file_name" v-model="file_name"
                               :placeholder="$t('form.file_name')">
                    </div>
                </div>
            </form>
        </modal>

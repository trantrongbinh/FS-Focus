    ...
    <div class="row">
        <form class="col-sm-4 offset-sm-4" role="form" @submit.prevent="onSubmit" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="name" name="name" :placeholder="$t('form.link_name')"
                       v-model="link.name">
            </div>
            <div class="form-group">
                <label for="link">{{ $t('form.link') }}</label>
                <input type="link" class="form-control" id="link" name="link" :placeholder="$t('form.link')"
                       v-model="link.link">
            </div>
            <div class="form-group">
                ...
                <div class="upload-box">
                    ...
                    <img v-if="link.image" :src="link.image" :alt="link.name" width="100" height="100"

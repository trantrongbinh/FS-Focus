                                ...
                                <div class="row d-flex post card">
                                    <div class="text col-lg-12 card-body">
                                        @if(Auth::check() && Auth::user()->id == $discussion->user->id)
                                            <a href="javascript:;" class="float-right" data-toggle="dropdown"><i
                                        ...
                                        <div class="text-inner d-flex align-items-center">
                                            <div class="content">
                                                <header class="post-header">
                                                    ...
                                                    <a href="{{ url('discussion', ['id' => $discussion->id]) }}"><h3
                                                                class="h4">{{ $discussion->title }}</h3></a>
                                                ...
                                                <footer class="post-footer d-flex align-items-center"><a href="#"
                                                        ...
                                                        <div class="avatar"><img
                                                                    src="{{ $discussion->user->avatar ?? config('blog.default_avatar') }}"
                                                                    alt="Avatar" class="img-fluid"></div>
                                                        <div class="title">
                                                            <span> {{ $discussion->user->name or 'null' }} </span></div>
                                                    </a>
                                                    <div class="date"><i
                                                                class="far fa-clock"></i> {{ $discussion->created_at->diffForHumans() }}
                                                    </div>
                                                    <div class="comments"><a
                                                                href="{{ url('discussion', ['id' => $discussion->id]) }}"><i
                                                                    class="far fa-comment-alt"> {{ $discussion->comments->count() }}</i> {{ lang('Replies') }}
                                                        </a></div>
                                                </footer>
                                            </div>
                                        </div>

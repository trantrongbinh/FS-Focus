...
@section('content')
    <div class="discussion container-fluid mb-4">
        <div class="row">
            
            @include('modules.left-box')

            <div class="posts-listing col-md-7">
                <div class="border" style="padding: 10px; background: #f7f7f7; border-radius: 2px; margin: 50px 0 30px 0;">
                    @if (Auth::guest())

                ...
                <div class="row">
                            ...
                            <ul class="list-unstyled">
                                <li>
                                   <a class="claps_button btn-tool ">
                                        <svg class="svgIcon-use hide" width="33" height="33" viewBox="0 0 33 33">
                    ...
                    <div class="col-lg-4 latest">
                        <div class="widget links" style="border: none;">
                            ...
                            <ul class="list-unstyled">
                                <li><a href="#"><i class="fab fa-facebook-square"></i> Laravel : How do I get records from pivot table whereby its foreign key does not reference a primary key?</a></li> 
                                <li><a href="#"><i class="fab fa-twitter"></i> Laravel : How do I get records from pivot table whereby its foreign key does not reference a primary key?</a></li> 
                                <li><a href="#"><i class="fab fa-github"></i> Laravel : How do I get records from pivot table whereby its forei</a></li> 
                                <li><a href="#"><i class="fab fa-stack-overflow"></i> Laravel : How do I get records from pivot table whereby its foreign key does not reference a primary key? Laravel : How do I get records from pivot table whereby its foreign key does not reference a primary key?</a></li>
                                <li><a href="#"><i class="fab fa-facebook-square"></i> Laravel : How do I get records from pivot table whereby its foreign key does not reference a primary key?</a></li> 
                                <li><a href="#"><i class="fab fa-twitter"></i> Laravel : How do I get records from pivot table whereby its foreign key does not reference a primary key?</a></li> 
                            </ul>
                        </div>

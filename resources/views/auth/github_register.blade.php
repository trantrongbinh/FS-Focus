                            ...
                            <div class="form-group">
                                <div class="col-md-10 offset-md-1">
                                    ...
                                    <input id="name" type="text"
                                           ...
                                           name="name" value="{{ $oauthData['github_name'] or '' }}"
                                           placeholder="{{ lang('Input Name') }}" required>
                            ...
                            <div class="form-group">
                                <div class="col-md-10 offset-md-1">
                                    ...
                                    <input id="email" type="email"
                                           ...
                                           name="email" value="{{ $oauthData['email'] or '' }}"
                                           placeholder="{{ lang('Input Email') }}" required>
                            ...
                            <div class="form-group">
                                <div class="col-md-10 offset-md-1">
                                    <label for="password-confirm"
                                           class="control-label">{{ lang('Confirm Password') }}</label>

                                    <input id="password-confirm" type="password"
                                           class="form-control{{ $errors->has('password_confirmation') ? ' is-invalid' : '' }}"
                                           name="password_confirmation"
                                           placeholder="{{ lang('Input Confirm Password') }}" required>

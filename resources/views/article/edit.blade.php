                        ...
                        <form class="form" action="{{ url("article/{$article->id}/edit") }}" method="POST">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-11">
                                    ...
                                    @endif
                                    <input type="text" id="title" name="title" class="form-control{{ $errors->has('title') ? ' is-invalid' : '' }}" value="{{ $article->title }}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="subtitle" class="col-sm-1 col-form-label">Subtitle</label>
                                <div class="col-sm-11">
                                    <input type="text" id="subtitle" name="subtitle" class="form-control" value="{{ $article->subtitle }}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="title" class="col-sm-1 col-form-label"></label>
                            ...
                            <form-content content="{{ $article->content['raw'] }}" url_image="{{ $article->page_image }}"></form-content>
                            <div class="form-group row">
                                <label for="meta_description" class="col-sm-1 col-form-label">Meta Description</label>
                                <div class="col-sm-11">
                                    <textarea id="meta_description" name="meta_description" class="form-control">{{ $article->meta_description }}</textarea>
                                </div>
                            </div>

                            ...
                            <div class="text col-lg-8">
                                <div class="text-inner d-flex align-items-center">
                                    <div class="content">
                                        ...
                                        <p><b>{{ $article->subtitle }} </b> {{ $article->meta_description }} <a class="text-blue" href="{{ url($article->slug) }}">... more</a></p>
                                        <footer class="post-footer d-flex align-items-center" style="font-size: 0.8em;"><a href="#" class="author d-flex align-items-center flex-wrap">
                                            <div class="avatar img-sm"><img src="/img/avatar-1.jpg" alt="..." class="img-fluid"></div>
                                            <div class="title"><span><b> {{ $article->user->name or 'null' }} </b></span></div></a>
                                            <div class="date"><i class="far fa-clock"></i> {{ $article->published_at->diffForHumans() }}</div>
                                            <div class="comments"><i class="fas fa-eye"></i> {{ $article->view_count }}</div>
                                        </footer>
                                    </div>
                                </div>
                            </div>
